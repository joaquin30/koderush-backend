...
class DynamoMatchManager:
    def __init__(self, match_id):
        ...
        self.matches_table_name = "Matches"  # Persistent table with match config
    ...
    def add_player(self, player_id):
        ...
        try:
            table.put_item(Item={"player": player_id})
    ...
    def get_match_metadata(self):
        table = self.dynamodb.Table(self.matches_table_name)
        response = table.get_item(Key={"match_id": self.match_id})
